        ...
        <div className="p-8">
          ...
          <div className="text-center mb-6">
            <div className="inline-block mb-2">
              <span className="text-2xl font-bold text-blue-600">COOL</span>
              <span className="text-2xl font-bold text-gray-400">.</span>
              <span className="text-2xl font-bold text-blue-600">CLUB</span>
            </div>
            <h2 className="text-2xl font-bold mt-4 mb-2">
              Rất nhiều đặc quyền và quyền lợi mua sắm đang chờ bạn
            </h2>
            <p className="text-gray-600 text-sm">
              Quyền lợi dành riêng cho bạn khi tham gia Coolclub
            </p>
          </div>
          ...
          <div className="grid grid-cols-3 gap-4 mb-6">
            <div className="text-center">
              ...
              <p className="text-xs text-gray-600">Voucher ưu đãi</p>
            </div>
            <div className="text-center">
              <div className="w-16 h-16 bg-purple-100 rounded-full flex items-center justify-center mx-auto mb-2">
                <span className="text-2xl">🎁</span>
              </div>
              <p className="text-xs text-gray-600">Quà tặng độc quyền</p>
            </div>
            <div className="text-center">
              <div className="w-16 h-16 bg-green-100 rounded-full flex items-center justify-center mx-auto mb-2">
                <span className="text-2xl">💰</span>
              </div>
              <p className="text-xs text-gray-600">Hoàn tiền CoolCash</p>
            </div>
          </div>
          ...
          <div className="mt-4 flex justify-between text-sm">
            ...
            <Link href="/quen-mat-khau" className="text-gray-600 hover:underline">
              Quên mật khẩu
            </Link>
          </div>
        </div>
